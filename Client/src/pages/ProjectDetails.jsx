            ...
            <div className="flex max-md:flex-col gap-4 flex-wrap items-start justify-between max-w-6xl">
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <span className={`px-2 py-1 rounded text-xs capitalize ${statusColors[project.status] || "bg-gray-200 text-gray-800"}`} >
                            {project.status ? project.status.replace(/_/g, " ") : "No status"
                            }
                        </span>
                    </div>
                </div>
